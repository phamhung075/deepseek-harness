...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  sessionAppends: 'persistence.md',
  sessionStreams: 'persistence.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SessionAppendSubscription: 'persistence.md',
  SessionAppendsWatchOptions: 'persistence.md',
  SessionStreamRecord: 'persistence.md',
  SessionStreamSink: 'persistence.md',
  SessionStreamSubscription: 'persistence.md',
  SessionStreamsWatchOptions: 'persistence.md',
